...
export default function Button({ children, disabled, to, type }) {
  ...
  const styles = {
    ...
    secondary:
      base +
      " px-4 py-2.5 bg-transparent border-2 border-stone-300 md:px-6 md:py-3.5 text-stone-400 hover:bg-stone-300 focus:bg-stone-300 hover:text-stone-800 focus:text-stone-800 focus:ring-stone-200",
